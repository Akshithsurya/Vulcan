...
<table>
  ...
  <tr>
    <td><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apple/apple-original.svg" width="20"/> <b>macOS</b></td>
    <td>✅ Full Support</td>
...
### 📥 Method 2: Complete Setup with Dependencies
...
<details>
<summary><b>🐧 Ubuntu/Debian/Kali Linux</b></summary>
...
```bash
CONFIGURATION:
Enter attacker IP address [default: 127.0.0.1]: 127.0.0.1
Enter attacker port [default: 4444]: 4444
Configure advanced options? [y/N]: n
```

**⚠️ IMPORTANT:** Always use `127.0.0.1` (localhost) for educational purposes!

#### **Step 2: Target Operating System**
...
Enable auto-execution on installation? [Y/n]: n
...
Enable Fake GUI (Social Engineering)? [Y/n]: n

✓ Payload will run silently (no window)
```
...
<details>
<summary><b>📗 Scenario 2: Cross-Platform Study</b></summary>
...
<details>
<summary><b>📙 Scenario 3: Advanced Features Demo</b></summary>
...
- Basic obfuscation understanding
...
║  ✅ ALWAYS use 127.0.0.1 for educational purposes         ║
